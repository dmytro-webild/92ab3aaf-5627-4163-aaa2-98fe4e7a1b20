...
export const metadata: Metadata = {
  title: "ZARAVYA | Wearable Art. Limited Pieces. Hyper Luxury.",  description: "Discover ZARAVYA's exclusive collection of hand-painted luxury garments. Each piece is a unique work of art created by master artisans."};
