...
export const metadata: Metadata = {
  title: "ZARAVYA - Wearable Art. Limited Pieces. Hyper Luxury.",
  description: "Discover hand-painted luxury fashion pieces. ZARAVYA creates unique, limited-edition wearable art for collectors who appreciate artisanal craftsmanship and exclusivity.",
  keywords: "luxury fashion, hand-painted clothing, wearable art, limited edition, designer pieces, artisanal, exclusive fashion",
  metadataBase: new URL("https://zaravya.com"),
  alternates: {
    canonical: "https://zaravya.com",
  },
  openGraph: {
    title: "ZARAVYA - Wearable Art",
    description: "Hand-painted limited edition luxury fashion. Each piece is a unique masterpiece.",
    url: "https://zaravya.com",
    siteName: "ZARAVYA",
    type: "website",
    images: [
      {
        url: "http://img.b2bpic.net/free-photo/abstract-liquid-marble-orange-background-diy-experimental-art_53876-103616.jpg",
        alt: "ZARAVYA luxury hand-painted wearable art",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "ZARAVYA - Wearable Art. Limited Edition Luxury.",
    description: "Hand-painted fashion pieces for collectors who appreciate artisanal excellence.",
    images: [
